...
<body>
    ...
    <form class="question-item col-lg-5  mt-2 mx-auto border rounded shadow-sm" method="GET" action="../php/supervisorAnswers.php">
        ...
        <input type="hidden" name="user_id" value="<?php echo $_SESSION['supervisor_id'] ?>">
